# tutorial reference - https://dontrepeatyourself.org/post/yolov4-custom-object-detection-with-opencv-and-python/
...
images_list = glob.glob("test/*.jpg")
...
for image_path in images_list:
    ...
    yolo_config = "yolov4-tiny-custom-uniform.cfg"
    yolo_weights = "yolov4-tiny-custom-uniform_final.weights"
